...
class Client (object):
    def __init__(
        ...
        self.cert_file = "{}/{}:{}.crt".format(
                            self.certs_dir, self.tenant, self.device_id)
        self.key_file = "{}/{}:{}.key".format(
                            self.certs_dir, self.tenant, self.device_id)
        ...
        self._mqttc.tls_set(ca_certs=self.ca_cert,
    ...
    def alert(self, message):
        if(self.is_connected):
            ...
            self._logger.info("Client not connected")
